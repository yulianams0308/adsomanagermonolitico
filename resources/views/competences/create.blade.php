...
<body>
  <form action="{{route('competences.store')}}" method="POST" >
    ...
    <label for="exampleFormControlInput1">Nombre competencia</label>
    <input type="text" class="form-control" name="nombre_competencia" placeholder="">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="anexo" placeholder="">
  </div>
