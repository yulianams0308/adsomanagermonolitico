...
<head>
    ...
    <link href="{{ asset('../public/img/logo2.png') }}" rel="icon">
...
<body>
    ...
    <header class="header2">
        ...
        <nav>
            <ul class="navigation">
                <li><a href="/html/home.html"><i class="fa-solid fa-house fa-lg" style="color: #ffffff;"></i></a></li>
                <li>
        ...
        <div class="navbar1">
            <a class="logo" href="/html/home.html"><img src="{{ asset('../public/img/logo.png') }}" alt=""></a>
            <h1 class="titulo_logo">ADSO Manager</h1>
        </div>

        <div class="navbar2">
            <a href="/html/panel.html">Panel</a>
            <a href="/html/perfil.html">Cuenta</a>

            <a href="/index.html">Salir</a>
            <a href="/html/perfil.html">Administrador</a>
